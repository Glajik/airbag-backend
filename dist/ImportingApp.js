...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"doImport\", function() { return doImport; });\n/* harmony import */ var _outter_AcceptancePlastic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outter/AcceptancePlastic */ \"./src/outter/AcceptancePlastic.js\");\n/* harmony import */ var _outter_AcceptanceBags__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./outter/AcceptanceBags */ \"./src/outter/AcceptanceBags.js\");\n/* harmony import */ var _outter_AirbagCRM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./outter/AirbagCRM */ \"./src/outter/AirbagCRM.js\");\n/* harmony import */ var _db_Parts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./db/Parts */ \"./src/db/Parts.js\");\n/* harmony import */ var _importing_partHelpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./importing/partHelpers */ \"./src/importing/partHelpers.js\");\n/* eslint-disable */\n\n\n\n\n\n/*\n      state: {\n        type: 'SEND_TO_PLASTIC',\n        label: 'Отправил в работу',\n        destination: {\n          name: 'plastic',\n          label: 'Пластик'\n        },\n        person: {\n          account: 'andrey.autocrash@gmail.com',\n          name: 'Андрей Ст.',\n          department: {\n            name: 'plastic',\n            label: 'Пластик'\n          }\n        }\n      }\n\n*/\n// eslint-disable-next-line max-len\n\nvar regexp = /^(?:=ГИПЕРССЫЛКА\\( *\")(https:\\/\\/drive\\.google\\.com\\/drive\\/.+)(?:\" *; *\".+\" *\\))$/g; // eslint-disable-next-line no-undef\n\nvar prepare = function prepare(data) {\n  return {\n    uuid: Utilities.getUuid(),\n    data: JSON.stringify(data)\n  };\n};\n/**\n * TODO:\n * - use right person for fill comments. Get it from ... maybe airbagCRM\n */\n// eslint-disable-next-line import/prefer-default-export\n\n\nvar doImport = function doImport() {\n  var plasticExportData = new _outter_AcceptancePlastic__WEBPACK_IMPORTED_MODULE_0__[\"default\"]().extractAll();\n  var bagsExportData = new _outter_AcceptanceBags__WEBPACK_IMPORTED_MODULE_1__[\"default\"]().extractAll();\n  var airbagcrmExportData = new _outter_AirbagCRM__WEBPACK_IMPORTED_MODULE_2__[\"default\"]().extractAll();\n  var partsData = plasticExportData.map(function (_ref) {\n    var valuesObj = _ref.valuesObj,\n        formulasObj = _ref.formulasObj,\n        notesObj = _ref.notesObj;\n    var orderId = valuesObj.orderId,\n        model = valuesObj.model,\n        color = valuesObj.color;\n    return prepare({\n      orderId: orderId,\n      model: model,\n      color: color,\n      partType: Object(_importing_partHelpers__WEBPACK_IMPORTED_MODULE_4__[\"getPartType\"])(valuesObj),\n      comments: [],\n      state: Object(_importing_partHelpers__WEBPACK_IMPORTED_MODULE_4__[\"getPartState\"])(valuesObj)\n    });\n  });\n  var commentsData = plasticExportData.map(function (_ref2) {\n    var valuesObj = _ref2.valuesObj;\n    var orderId = valuesObj.orderId,\n        commentPlastic = valuesObj.commentPlastic;\n    return prepare({\n      type: 'order',\n      orderId: orderId,\n      text: commentPlastic,\n      from: {\n        name: 'Максим',\n        account: 'autocrash.maksim@gmail.com',\n        department: 'managers'\n      },\n      to: {\n        name: '*',\n        account: '*',\n        department: 'plastic'\n      },\n      createdAt: getOrderCreateAt(orderId)\n    });\n  });\n  var photosData = plasticExportData.map(function (_ref3) {\n    var valuesObj = _ref3.valuesObj,\n        formulasObj = _ref3.formulasObj,\n        notesObj = _ref3.notesObj;\n    var orderId = valuesObj.orderId;\n    return prepare({\n      type: 'order',\n      orderId: orderId,\n      text: commentPlastic,\n      to: {\n        name: '*',\n        account: '*',\n        department: 'plastic'\n      },\n      from: {\n        name: 'Максим',\n        account: 'autocrash.maksim@gmail.com',\n        department: 'managers'\n      }\n    });\n  }); // eslint-disable-next-line no-undef\n\n  new _db_Parts__WEBPACK_IMPORTED_MODULE_3__[\"default\"]().updateSheet(partsData);\n};\n\n//# sourceURL=webpack://%5Bname%5D/./src/ImportingApp.js?");

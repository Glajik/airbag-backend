(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["TestingApp"] = factory();
	else
		root["TestingApp"] = factory();
})(this, function() {
...
exports.AssertionError = __webpack_require__(104);
...
var assertion = __webpack_require__(129);
...
var expect = __webpack_require__(131);
exports.use(expect);
...
var should = __webpack_require__(132);
exports.use(should);
...
var isProxyEnabled = __webpack_require__(65);
...
var getName = __webpack_require__(107);
var getProperties = __webpack_require__(108);
var getEnumerableProperties = __webpack_require__(117);
var config = __webpack_require__(59);
...
var pathval = __webpack_require__(112);
...
exports.type = __webpack_require__(102);

/*!
 * expectTypes utility
 */
exports.expectTypes = __webpack_require__(115);

/*!
 * message utility
 */

exports.getMessage = __webpack_require__(116);

/*!
 * actual utility
 */

exports.getActual = __webpack_require__(105);

/*!
 * Inspect util
 */

exports.inspect = __webpack_require__(103);

/*!
 * Object Display util
 */

exports.objDisplay = __webpack_require__(106);
...
exports.getName = __webpack_require__(107);

/*!
 * add Property
 */

exports.addProperty = __webpack_require__(119);
...
exports.overwriteProperty = __webpack_require__(121);

/*!
 * overwrite Method
 */

exports.overwriteMethod = __webpack_require__(122);

/*!
 * Add a chainable method
 */

exports.addChainableMethod = __webpack_require__(123);

/*!
 * Overwrite chainable method
 */

exports.overwriteChainableMethod = __webpack_require__(124);

/*!
 * Compare by inspect method
 */

exports.compareByInspect = __webpack_require__(125);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(109);

/*!
 * Get own enumerable properties method
 */

exports.getOwnEnumerableProperties = __webpack_require__(126);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(127);

/*!
 * Proxify util
 */

exports.proxify = __webpack_require__(67);

/*!
 * addLengthGuard util
 */

exports.addLengthGuard = __webpack_require__(66);

/*!
 * isProxyEnabled helper
 */

exports.isProxyEnabled = __webpack_require__(65);

/*!
 * isNaN method
 */

exports.isNaN = __webpack_require__(128);
...
var AssertionError = __webpack_require__(104);
var flag = __webpack_require__(12);
...
var flag = __webpack_require__(12)
  , getActual = __webpack_require__(105)
  , objDisplay = __webpack_require__(106);
...
var chai = __webpack_require__(57);
var flag = __webpack_require__(12);
var isProxyEnabled = __webpack_require__(65);
...
var addLengthGuard = __webpack_require__(66);
var chai = __webpack_require__(57);
var flag = __webpack_require__(12);
var proxify = __webpack_require__(67);
var transferFlags = __webpack_require__(58);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(109);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var Importing_test_namespaceObject = {};
__webpack_require__.r(Importing_test_namespaceObject);
__webpack_require__.d(Importing_test_namespaceObject, "doTests", function() { return Importing_test_doTests; });

// EXTERNAL MODULE: ./node_modules/lodash/omit.js
var omit = __webpack_require__(5);

// CONCATENATED MODULE: /home/slavik/Work/@glajik/kava/src/kava.js
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }
  ...
  _createClass(Kava, [{
    ...
    value: function make(task, fn) {
      try {
        // invoce funciton
        fn();
        this.results = [].concat(_toConsumableArray(this.results), [{
          task: task,
          result: 'OK',
          success: true
        }]);
...
// EXTERNAL MODULE: ./src/ImportingApp.js + 11 modules
var ImportingApp = __webpack_require__(68);

// EXTERNAL MODULE: ./src/db.js
var db = __webpack_require__(8);

// CONCATENATED MODULE: ./src/tests/Importing.test.js
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
var test = new Kava('Importing integration test'); // eslint-disable-next-line import/prefer-default-export

var Importing_test_doTests = function doTests() {
  var partUuid; // check for this orderId

  var orderId = 3917;
  test.make('test Import', function () {
    Object(ImportingApp["doImport"])();
  });
  test.make('Parts. First entry should be equal to assertion', function () {
    // search part in db
    var queryResult = db["b" /* parts */].dataColl.filter(function (o) {
      return o.orderId === orderId;
    });
    Object(chai["expect"])(queryResult).is.length.is.equal(2);

    var _queryResult = _slicedToArray(queryResult, 1),
        first = _queryResult[0]; // used in next tests


    partUuid = first.uuid;
    var rowId = first.rowId,
        data = first.state;
    Object(chai["expect"])(rowId).at.least(400);
    Object(chai["expect"])(rowId).at.most(1000); // remove uuid from state

    Object(omit["omit"])(data.state, 'uuid'); // check it

    Object(chai["expect"])(data).is.equal({
      orderId: orderId,
      model: 'БМВ',
      color: '',
      partType: {
  ...
  test.make('States. Check entries.', function () {
    // search part in db
    var queryResult = db["d" /* states */].dataColl.filter(function (o) {
      return o.partUuid === partUuid;
    });
    Object(chai["expect"])(queryResult).is.length.is.equal(5);

    var _queryResult2 = _slicedToArray(queryResult, 5),
        acceptanceFirst = _queryResult2[0],
        plasticFirst = _queryResult2[1],
        plasticMid = _queryResult2[2],
        plasticLast = _queryResult2[3],
        acceptanceLast = _queryResult2[4];
    ...
    Object(chai["expect"])(acceptanceFirst.state).is.deep.equal({
    ...
    Object(chai["expect"])(acceptanceLast.state).is.deep.equal({
    ...
    Object(chai["expect"])(plasticFirst.state).is.deep.equal({
    ...
    Object(chai["expect"])(plasticMid.state).is.deep.equal({
    ...
    Object(chai["expect"])(plasticLast.state).is.deep.equal({
...
//   return test;
// };
// CONCATENATED MODULE: ./src/TestingApp.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "doAllTests", function() { return doAllTests; });

var tests = [Importing_test_namespaceObject]; // eslint-disable-next-line import/prefer-default-export

var doAllTests = function doAllTests() {
  var results = tests.map(function (test) {
    return test.doTests();
  });
  var output = results.map(function (r) {
    return r.output;
  }).join('\n');
  var errors = results.map(function (r) {
    return r.errCount;
  }).reduce(function (acc, errCount) {
    return errCount > 0 ? acc + 1 : acc;
  }, 0);
  var total = tests.length;
  return ['', output, '===================================', "".concat(errors === 0 ? 'PASSED' : 'NOT PASSED', " - Tested modules: ").concat(total, ", not passed: ").concat(errors)].join('\n');
};
